...
namespace IsoTools {
	...
	public class IsoWorld : MonoBehaviour {
		...
		void StepSort() {
			UnityEngine.Profiling.Profiler.BeginSample("UpdateVisibles");
			UpdateVisibles();
			UnityEngine.Profiling.Profiler.EndSample();
			if ( _dirty ) {
				UnityEngine.Profiling.Profiler.BeginSample("PlaceAllVisibles");
				PlaceAllVisibles();
				UnityEngine.Profiling.Profiler.EndSample();
				_dirty = false;
			}
		...
		void UpdateVisibles() {
			UnityEngine.Profiling.Profiler.BeginSample("CalculateNewVisibles");
			CalculateNewVisibles();
			UnityEngine.Profiling.Profiler.EndSample();

			UnityEngine.Profiling.Profiler.BeginSample("CalculateSectors");
			SetupSectorSize();
			SetupObjectsSectors();
			SetupSectors();
			UnityEngine.Profiling.Profiler.EndSample();

			UnityEngine.Profiling.Profiler.BeginSample("ResolveVisibles");
			ResolveVisibles();
			UnityEngine.Profiling.Profiler.EndSample();
		}
